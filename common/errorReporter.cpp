...
//{ "crmacct_owner_username_check",             Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  ...
  { "cntctphone_crmrole_id_fkey",               Delete,  0, QT_TRANSLATE_NOOP("errorReporter", "Cannot delete this CRM Role as it is referenced by Phone numbers.") },
...
//{ "emp_emp_mgr_emp_id_fkey",                  Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  ...
  { "emp_crmacct_id_fkey",                      Delete,  0,  QT_TRANSLATE_NOOP("errorReporter", "Cannot delete CRM Account because it is an Employee.") },
...
//{ "rev_check",                                Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  ...
  { "salesrep_crmacct_id_fkey",                 Delete,  0,  QT_TRANSLATE_NOOP("errorReporter", "Cannot delete CRM Account because it is a Sales Rep.") },
...
//{ "taxauth_taxauth_curr_id_fkey",             Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  { "taxauth_crmacct_id_fkey",                  Delete,  0,  QT_TRANSLATE_NOOP("errorReporter", "Cannot delete CRM Account because it is a Tax Authority.") },
...
//{ "vendinfo_vend_addr_id_fkey",               Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  { "vendinfo_crmacct_id_fkey",                 Delete,  0,  QT_TRANSLATE_NOOP("errorReporter", "Cannot delete CRM Account because it is a Vendor.") },
